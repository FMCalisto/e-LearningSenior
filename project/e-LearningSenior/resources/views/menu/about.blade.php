...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SEPP</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="fp-index.html" target="_blank">Project</a>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="lesson_8.html">Lesson 8</a>
                            </li>
                            <li>
                                <a href="lesson_9.html">Lesson 9</a>
                            </li>
                            <li>
                                <a href="lesson_11.html">Lesson 11</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <h1>Senior e-Learning Platform Project</h1>
            <p class="lead">

              This project aims to create an Online Learning for Elderly Platform under the User Centered Design class at Instituto Superior Técnico, Universidade de Lisboa - Portugal.

              <a href="https://fenix.tecnico.ulisboa.pt/disciplinas/CCU3517/2015-2016/1-semestre/project-bc5" target="_blank">
            ...
            <p>
                ...
                On this project, we suggest the application of
